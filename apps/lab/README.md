...
exporter, alongside the usual Principia `MetaGuard`/`BaseMixin` wiring every service in
...
| --------------------------- | ------- | --------------------------------------------------------- |
| `PRINCIPIA_PROMETHEUS_PORT` | `3030`  | Port the Prometheus metrics reporter listens on.          |
