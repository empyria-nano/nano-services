...
export default {
		...
		},
		{
			...
			options: {
				...
				pino: {
					...
					destination: env.LOG_FILE || './tmp/moleculer.log',
				},
			},
		},
	],
	...
	transporter: env.MOLECULER_TRANSPORTER,

	// Define a cacher.
	// More info: https://moleculer.services/docs/0.14/caching.html
	cacher: env.MOLECULER_CACHE_ENABLED && {
		type: 'Redis',
		options: {
			prefix: env.MOLECULER_CACHE_PREFIX,
			ttl: 30,
			redis: {
				url: env.MOLECULER_CACHE_URL,
			},
		},
	},
