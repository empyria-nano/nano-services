...
import { EMPYRIA_FEDERATION_ID, MOLECULER_SERVICE_ROLE } from '@empyria/common'
...
describe('Acme.service.js', () => {
	...
	test('starts under a broker and gets a Empyria meta stamped via BaseMixin', async () => {
		...
		expect(svc.meta.user.federation).toBe(EMPYRIA_FEDERATION_ID)
