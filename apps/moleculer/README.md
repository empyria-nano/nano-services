...
`BaseMixin` (from `@empyria/moleculer`) for the standard Empyria meta-stamping and
...
| ------------------------- | ------- | ------------------------------------------------ |
| `EMPYRIA_PROMETHEUS_PORT` | `3031`  | Port the Prometheus metrics reporter listens on. |
